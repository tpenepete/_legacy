...
class tpt_gclass_EPS extends tpt_PreviewGenerator {
	...
	@unlink(TPT_RESOURCE_DIR.DIRECTORY_SEPARATOR.'potrace.eps');
	...
	$IMCommand .= '			--eps ';
	//$IMCommand .= '			--input-format=png ';
	$IMCommand .= '			--resolution 1024 ';
	$IMCommand .= '			--alphamax 0.5 ';
	...
	//$IMCommand .= '			--preserve-width ';
	//$IMCommand .= '			--remove-adjacent-corners ';
	$IMCommand .= '			--output '.TPT_RESOURCE_DIR.DIRECTORY_SEPARATOR.'potrace.eps';
	$IMCommand .= '			'.TPT_RESOURCE_DIR.DIRECTORY_SEPARATOR.'test.pnm ';
	$this->exec($vars, $steps, 'vector', $IMCommand, 2);
	@unlink(TPT_RESOURCE_DIR.DIRECTORY_SEPARATOR.'test.pnm');
	//var_dump($steps['errors']['vector']);die();
	$steps['vector'] = file_get_contents(TPT_RESOURCE_DIR.DIRECTORY_SEPARATOR.'potrace.eps');
