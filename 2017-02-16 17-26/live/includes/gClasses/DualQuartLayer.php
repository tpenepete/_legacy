...
class tpt_gclass_DualQuartLayer extends tpt_PreviewGenerator {
	...
	//die('asdasdasdasas');
	    ...
	    */
	    ...
	    //$IMCommand .= '	-trim ';
	    $IMCommand .= '	png:- ';
	    $this->exec($vars, $steps, 'DualQuartInner', $IMCommand, 2);
	    //if($_SERVER['REMOTE_ADDR'])
	    //var_dump($options);die();
	    //var_dump($IMCommand);die();
	    //var_dump($steps['errors']);die();
	    //return $steps['SomeStuff'];
	    $overlay = $steps['DualQuartInner'];
	    }
